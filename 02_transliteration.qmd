...
- Type there and run the code chunk (it is about 25 s.)

```
!curl -s https://raw.githubusercontent.com/agricolamz/tsova_tush_fst_tools/refs/heads/main/Makefile -o Makefile; make
```

-  After that you can transliterate back and forth, using the following command (*at't'iv* means 'fate, luck', *pħe* means 'village')):

```
!echo "ატტივ" | awk -f tsova_tush_fst_tools/mkh2la.awk

at't'iv
```

```
!echo "pħe" | awk -f tsova_tush_fst_tools/la2mkh.awk
