...
- In order to gloss you need to use the following command[^glossing_problems] (I expect that *badreⁿ akʼvaⁿ* means 'child's cradle'):

[^glossing_problems]: This is just a preliminary tool. There are some known problems that are listed in the following file. 
