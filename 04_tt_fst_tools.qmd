...
- In order to see all possible forms for some form you can run a substring serch. In order to do it, all symbols should be separated by spaces, all tags should be sorounded by `%<...%>` (*pħit'* means 'frog'):
